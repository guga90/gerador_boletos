...
<html lang="pt">
    <head>
        ...
        <script src="<?php echo $this->baseUrl ?>/public/scripts/startbootstrap-sb-admin-2-1.0.7/bower_components/datatables/media/js/jquery.dataTables.js"></script>
        <script src="<?php echo $this->baseUrl ?>/public/scripts/startbootstrap-sb-admin-2-1.0.7/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>

        <script src="<?php echo $this->baseUrl ?>/public/scripts/jquery-maskmoney/jquery.maskMoney.js"></script>
        ...
        <script src="<?php echo $this->baseUrl ?>/public/scripts/controles/<?php echo $this->_controleNome ?>.js"></script>
