...
<HTML>
    ...
    <BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
        ...
        <BR><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
                ...
                <td width=3 valign=bottom><img height=22 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/3.png" width=2 border=0></td><td class=cpt width=58 valign=bottom><div align=center><font class=bc><?php echo $dadosboleto["codigo_banco_com_dv"] ?></font></div></td><td width=3 valign=bottom><img height=22 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/3.png" width=2 border=0></td><td class=ld align=right width=453 valign=bottom><span class=ld> 
            ...
            </tr><tbody><tr><td colspan=5><img height=2 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/2.png" width=666 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/1.png" width=1 border=0></td><td class=ct valign=top width=268 height=13>Cedente</td><td class=ct valign=top width=7 height=13><img height=13 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/1.png" width=1 border=0></td><td class=ct valign=top width=156 height=13>Agência/Código
                        ...
                        número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/1.png" width=1 border=0></td><td class=cp valign=top width=268 height=12>
                ...
                </tr><tr><td valign=top width=7 height=1><img height=1 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/2.png" width=7 border=0></td><td valign=top width=472 height=1><img height=1 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/2.png" width=472 border=0></td><td valign=top width=7 height=1><img height=1 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/2.png" width=7 border=0></td><td valign=top width=180 height=1><img height=1 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/2.png" width=180 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/1.png" width=1 border=0></td><td class=ct valign=top width=472 height=13>Cedente</td><td class=ct valign=top width=7 height=13><img height=13 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/1.png" width=1 border=0></td><td class=ct valign=top width=180 height=13>Agência/Código 
        ...
        <td class=cp valign=top width=7 height=12><img height=12 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/1.png" width=1 border=0></td><td class=cp valign=top  width=62 height=12><div align=left><span class="campo">
            ...
            <td class=ct valign=top width=7 height=13> <img height=13 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/1.png" width=1 border=0></td><td class=ct valign=top COLSPAN="3" height=13>Uso 
                ...
                <img height=13 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/1.png" width=1 border=0></td><td class=ct valign=top width=43 height=13>Espécie</td><td class=ct valign=top height=13 width=7>
