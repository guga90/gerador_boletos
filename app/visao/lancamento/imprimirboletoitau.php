...
$dadosboleto["carteira"] = $boleto->getContaCarteira();  // Código da Carteira: pode ser 175, 174, 104, 109, 178, ou 157
// SEUS DADOS
...
$codigobanco = $boleto->getBancoCodigo(); //"341";
            ...
            <TBODY>
                <TR>
                    <TD class=ct width=666>
                        <img height=1 src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/6.png" width=665 border=0>
                    </TD>
                </TR>
                <TR>
                    <TD class=ct width=666>
...
<?php echo $dadosboleto["cidade_uf"]; ?><br>
        ...
        <BR><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150>
                    <span class="campo"><IMG
                            src="<?php echo $this->baseUrl ?>/library/Includes/boletophp/imagens/logoitau.jpg" width="150" height="40"
                            border=0></span></td>
