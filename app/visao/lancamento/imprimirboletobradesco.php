...
$dadosboleto["conta_cedente"] = $boleto->getContaNumero(); // ContaCedente do Cliente, sem digito (Somente Números)
$dadosboleto["conta_cedente_dv"] = $boleto->getContaNumerodigito(); // Digito da ContaCedente do Cliente
$dadosboleto["carteira"] = $boleto->getContaCarteira();  // Código da Carteira: pode ser 06 ou 03
//
// SEUS DADOS
