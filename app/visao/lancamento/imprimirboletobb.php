...
$dadosboleto["nosso_numero"] = str_pad($boleto->getLancamentoId(), 5, '0', STR_PAD_LEFT);  // Nosso numero - REGRA: Máximo de 8 caracteres!
...
$dadosboleto["convenio"] = $boleto->getContaConvenio();  // Num do convênio - REGRA: 6 ou 7 ou 8 dígitos
...
// TIPO DO BOLETO
$dadosboleto["formatacao_convenio"] = strlen($boleto->getContaConvenio()); // REGRA: 8 p/ Convênio c/ 8 dígitos, 7 p/ Convênio c/ 7 dígitos, ou 6 se Convênio c/ 6 dígitos
$dadosboleto["formatacao_nosso_numero"] = strlen($dadosboleto["nosso_numero"]) <= 5 ? "1" : "2"; // REGRA: Usado apenas p/ Convênio c/ 6 dígitos: informe 1 se for NossoNúmero de até 5 dígitos ou 2 para opção de até 17 dígitos
